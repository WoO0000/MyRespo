...
public class MainActivityLogin_Teacher extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_sign_up:
                ...
                intent.setClass(MainActivityLogin_Teacher.this, MainActivitySignup.class);
                startActivity(intent);
                break;
            case R.id.Login:
                if (Username.equals("") || Password.equals("")) {
                    Toast.makeText(MainActivityLogin_Teacher.this, "账号或密码为空", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if(dataResponseBody.getCode() == 200){
                                ...
                                Intent intent=new Intent();
                                intent.setClass(MainActivityLogin_Teacher.this,MainActivity3.class);
                                startActivity(intent);
                            }
                            else{
                                Toast.makeText(getApplicationContext(),dataResponseBody.getMsg(),Toast.LENGTH_SHORT).show();
